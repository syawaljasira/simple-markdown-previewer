...
Hi, I'm [Syawal](https://github.com/syawaljasira), this is my Markdown Previewer!
...
[Marked](marked.js.org) lets you convert **Markdown** into \`HTML\`.  Markdown is a simple text format whose goal is to be very easy to read and write, even when not converted to HTML.  This demo page will let you type anything you like and see how it gets converted.  Live.  No more waiting around.
How To Use It?
